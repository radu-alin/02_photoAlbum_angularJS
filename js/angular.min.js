...
(function (t, Y, s) {
  ...
  function Na(b) {
    ...
    return 1 === b.nodeType && a
      ? !0
      : C(b) || L(b) || 0 === a || ('number' === typeof a && 0 < a && a - 1 in b);
  }
  function r(b, a, c) {
    var d, e;
    if (b)
  ...
  function Ha(b, a, c, d) {
    ...
    if (a) {
      ...
      L(b)
        ...
        : S(b) &&
          ((e = Object.create(Object.getPrototypeOf(b))), (a = Ha(b, e, c, d)));
    return a;
  }
  function qa(b, a) {
    if (L(b)) {
  ...
  function cc(b, a) {
    ...
    return !D(a) || a instanceof RegExp
      ? a
      : c.length
      ? function () {
          return arguments.length
            ? a.apply(b, c.concat(Ta.call(arguments, 0)))
            : a.apply(b, c);
        }
      : function () {
  ...
  function ta(b) {
    ...
    try {
      return 3 === b[0].nodeType
        ? P(c)
        : c.match(/^(<[^>]+>)/)[1].replace(/^<([\w\-]+)/, function (a, c) {
            return '<' + P(c);
          });
    } catch (d) {
      return P(c);
  ...
  function gc(b, a, c) {
    ...
    t &&
      e.test(t.name) &&
      ((c.debugInfoEnabled = !0), (t.name = t.name.replace(e, '')));
    ...
    if (d && d.handle)
      if (a)
        r(a.split(' '), function (a) {
          F(c)
            ? (b.removeEventListener(a, e[a], !1), delete e[a])
            : Ra(e[a] || [], c);
        });
      else
        for (a in e)
  ...
  function mb(b, a) {
    ...
    d &&
      (a
        ? delete d.data[a]
        : (d.handle && (d.events.$destroy && d.handle({}, '$destroy'), uc(b)),
          delete ob[c],
          (b.ng339 = s)));
  }
  function nb(b, a) {
    ...
    a &&
      !c &&
      ((b.ng339 = c = ++Te), (c = ob[c] = { events: {}, data: {}, handle: s }));
    return c;
  }
  function Jb(b, a, c) {
    if (rc(b)) {
  ...
  function We(b) {
    return (b = b.toString().replace(Bc, '').match(Cc))
  ...
  function Mb(b, a, c) {
    ...
    if ('function' === typeof b) {
      if (!(d = b.$inject)) {
        d = [];
        if (b.length) {
          if (a) throw ((C(c) && c) || (c = b.name || We(b)), La('strictdi', c));
      ...
      L(b)
        ? ((a = b.length - 1), gb(b[a], 'fn'), (d = b.slice(0, a)))
        : gb(b, 'fn', !0);
    return d;
  }
  function Cb(b, a) {
          ...
          try {
            ...
            throw (
              ...
              e.message &&
                ...
                (e = e.message + '\n' + e.stack),
              La('modulerr', a, e.stack || e.message || e))
            );
          }
        }
      });
    ...
    function g(b, c) {
      function d(a) {
        if (b.hasOwnProperty(a)) {
          if (b[a] === h) throw La('cdep', a + ' <- ' + m.join(' <- '));
          return b[a];
        }
        try {
  ...
  function Ze(b, a, c, d) {
      ...
      if (a) {
        if (T != a)
          return (
            ...
            d.history
              ? c
                ? n.replaceState(null, '', a)
                : (n.pushState(null, '', a), v.attr('href', v.attr('href')))
    ...
    h.onUrlChange = function (a) {
      if (!ca) {
        ...
        if (d.hashchange) G(b).on('hashchange', g);
        else h.addPollFn(g);
        ca = !0;
      }
      Q.push(a);
      ...
      if (a)
        b === s
          ...
          : C(b) &&
            ((d =
              (m.cookie =
                encodeURIComponent(a) + '=' + encodeURIComponent(b) + ';path=' + M)
                .length + 1),
            4096 < d &&
              c.warn(
                "Cookie '" +
        ...
        if (m.cookie !== N)
          for (N = m.cookie, d = N.split('; '), J = {}, f = 0; f < d.length; f++)
            (e = d[f]),
              (h = e.indexOf('=')),
              0 < h &&
                ((a = decodeURIComponent(e.substring(0, h))),
                J[a] === s && (J[a] = decodeURIComponent(e.substring(h + 1))));
        return J;
      }
    };
      ...
      function b(b, d) {
        ...
        return (a[b] = {
          put: function (a, b) {
            ...
            if (!F(b))
              return a in m || g++, (m[a] = b), g > k && this.remove(l.key), b;
          },
          get: function (a) {
            if (k < Number.MAX_VALUE) {
              var b = n[a];
  ...
  function jc(b, a) {
    var c = {},
      ...
      e = /(([\d\w_\-]+)(?:\:([^;]+))?;?)/,
      f = rd('ngSrc,ngSrcset,src,srcset'),
      g = /^(on[a-z]+|formaction)$/;
      ...
      function (a, b, p, l, q, A, u, x, z, T, v) {
        ...
        function Q(a, b, c, d, e) {
          ...
          return function (b, c, d, e, l) {
            ...
            h ||
              (h = (l = l && l[0])
                ? 'foreignobject' !== pa(l) && l.toString().match(/SVG/)
                  ? 'svg'
                  : 'html'
                : 'html');
            'html' !== h &&
              a[0] !== k &&
              (g = G(Nb(h, G('<div>').append(a).html())));
            k = a[0];
            l = c ? Ia.clone.call(g) : g;
        ...
        function ca(a, b, c, d, e, f) {
          function h(a, c, d, e) {
            var f, k, l, n, u, q, ua;
            if (p)
              for (ua = Array(c.length), n = 0; n < g.length; n += 3)
                (f = g[n]), (ua[f] = c[f]);
            else ua = c;
            n = 0;
            for (u = g.length; n < u; )
              (k = ua[g[n++]]),
                ...
                (f = g[n++]),
                c
                  ? (c.scope ? ((l = a.$new()), Q.$$addScopeInfo(G(k), l)) : (l = a),
                    (q = c.transcludeOnThisElement
                      ? J(a, c.transclude, e, c.elementTranscludeOnThisElement)
          ...
          for (var g = [], k, l, n, u, p, q = 0; q < a.length; q++) {
            k = new Ob();
            l = N(a[q], [], k, 0 === q ? d : s, e);
            (f = l.length ? H(l, a[q], k, b, c, null, [], [], f) : null) &&
              f.scope &&
              Q.$$addScopeClass(k.$$element);
            k =
              (f && f.terminal) || !(n = a[q].childNodes) || !n.length
                ? null
                : ca(
                    n,
                    f
        ...
        function N(b, f, h, g, l) {
          ...
          switch (b.nodeType) {
            case 1:
              R(f, va(pa(b)), 'E', g, l);
              for (
                var p, q, T, A = b.attributes, z = 0, v = A && A.length;
                z < v;
                z++
              ) {
                var x = !1,
                ...
                if (!X || 8 <= X || p.specified) {
                  ...
                  a: {
                    ...
                    if (c.hasOwnProperty(H)) {
                      r = void 0;
                      for (
                        var H = a.get(H + 'Directive'), O = 0, Q = H.length;
                        O < Q;
                        O++
                      )
                        if (((r = H[O]), r.multiElement)) {
                          r = !0;
                          break a;
                        }
                    }
              ...
              if (C(b) && '' !== b)
                for (; (u = e.exec(b)); )
                  (q = va(u[2])),
                    R(f, q, 'C', g, l) && (h[q] = ba(u[3])),
                    (b = b.substr(u.index + u[0].length));
              break;
            case 3:
              t(f, b.nodeValue);
              break;
            case 8:
              try {
                if ((u = d.exec(b.nodeValue)))
                  (q = va(u[1])), R(f, q, 'M', g, l) && (h[q] = ba(u[2]));
              } catch (M) {}
          }
          f.sort(F);
          return f;
        ...
        function H(a, c, d, e, f, h, g, k, l) {
          function u(a, b, c, d) {
            ...
            if (b) {
              ...
              b.require = I.require;
              b.directiveName = ha;
              if (y === I || I.$$isolateScope) b = ga(b, { isolateScope: !0 });
              k.push(b);
            }
          }
          function T(a, b, c, d) {
          ...
          function z(a, e, f, h, l) {
            ...
            if (y) {
              ...
              Q.$$addScopeInfo(
                ...
                x,
                !0,
                !(ca && (ca === y || ca === y.$$originalDirective))
              );
              Q.$$addScopeClass(M, !0);
              h = H && H[y.name];
              var xa = x;
              h && h.identifier && !0 === y.bindToController && (xa = h.instance);
              r(y.scope, function (a, c) {
                ...
                switch (d) {
                  ...
                  case '=':
                    ...
                    h = e.$watch(
                      q(R[f], function (a) {
                        u(a, xa[c]) || (u(a, g) ? l(e, (a = xa[c])) : (xa[c] = a));
                        return (g = a);
                      }),
                      null,
                      k.literal
            ...
            for (p = g.length; h < p; h++)
              (v = g[h]),
                Dc(
                  ...
                  M,
                  R,
                  v.require && T(v.directiveName, v.require, M, W),
                  O
                );
            h = e;
          ...
          for (
            var v = -Number.MAX_VALUE,
              ...
              H,
              y = l.newIsolateScopeDirective,
              ca = l.templateDirective,
              R = l.nonTlbTranscludeDirective,
              w = !1,
              F = !1,
            ...
            if ((t = I.scope))
              I.templateUrl ||
                (S(t)
                  ? (K('new/isolated scope', y || x, I, aa), (y = I))
                  : K('new/isolated scope', y, I, aa)),
                (x = x || I);
            ha = I.name;
            !I.templateUrl &&
              I.controller &&
              ((t = I.controller),
              (J = J || {}),
              K("'" + ha + "' controller", J[ha], I, aa),
              (J[ha] = I));
            if ((t = I.transclude))
              (w = !0),
                I.$$tlb || (K('transclusion', R, I, aa), (R = I)),
                'element' == t
                  ? ((E = !0),
                    (v = I.priority),
                    (t = aa),
                    (aa = d.$$element = G(
                      Y.createComment(' ' + ha + ': ' + d[ha] + ' ')
                    )),
                    (c = aa[0]),
                    rb(f, Ta.call(t, 0), c),
                    (P = Q(t, e, v, h && h.name, { nonTlbTranscludeDirective: R })))
                  : ((t = G(Ib(c)).contents()), aa.empty(), (P = Q(t, e)));
            if (I.template)
              if (
                ((F = !0),
                K('template', ca, I, aa),
                (ca = I),
                (t = D(I.template) ? I.template(aa, d) : I.template),
                (t = V(t)),
                I.replace)
              ) {
                h = I;
                ...
                c = t[0];
                if (1 != t.length || 1 !== c.nodeType) throw ja('tplrt', ha, '');
                rb(f, aa, c);
                ya = { $attr: {} };
                t = N(c, [], ya);
            ...
            if (I.templateUrl)
              (F = !0),
                ...
                (ca = I),
                I.replace && (h = I),
                (z = $e(a.splice(ma, a.length - ma), aa, d, f, w && P, g, k, {
              ...
              try {
                (za = I.compile(aa, d, P)),
                  D(za) ? u(null, za, U, X) : za && u(za.pre, za.post, U, X);
              } catch ($) {
                p($, ta(aa));
              }
        ...
        function R(b, d, e, f, h, g, l) {
          ...
          if (c.hasOwnProperty(d)) {
            var n;
            d = a.get(d + 'Directive');
            for (var u = 0, q = d.length; u < q; u++)
              try {
                (n = d[u]),
                  (f === s || f > n.priority) &&
                    -1 != n.restrict.indexOf(e) &&
                    (g && (n = bc(n, { $$start: g, $$end: l })), b.push(n), (h = n));
              } catch (T) {
                p(T);
              }
          }
        ...
        function B(a, b) {
          ...
          r(b, function (b, f) {
            'class' == f
              ? (y(e, b), (a['class'] = (a['class'] ? a['class'] + ' ' : '') + b))
              : 'style' == f
        ...
        function $e(a, b, c, d, e, f, h, g) {
          var k = [],
            ...
            v = D(q.templateUrl) ? q.templateUrl(b, c) : q.templateUrl,
            A = q.templateNamespace;
          b.empty();
          ...
          return function (a, b, c, d, e) {
            a = e;
            k
              ? (k.push(b), k.push(c), k.push(d), k.push(a))
              : (n.transcludeOnThisElement && (a = J(b, n.transclude, e)),
                n(u, b, c, d, a));
          };
        }
        function F(a, b) {
        ...
        function rb(a, b, c) {
          ...
          for (e = b.length; d < e; d++)
            (f = b[d]), G(f).remove(), a.appendChild(f), delete b[d];
          b[0] = c;
          b.length = 1;
        }
        function ga(a, b) {
        ...
        Ob.prototype = {
          ...
          $set: function (a, b, c, d) {
            ...
            d
              ? (this.$attr[a] = d)
              : (d = this.$attr[a]) || (this.$attr[a] = d = Db(a, '-'));
            f = pa(this.$$element);
        ...
        return function (g, h, m, k) {
          ...
          C(g) &&
            ...
            (g = b.hasOwnProperty(p)
              ? b[p]
              : ic(h.$scope, p, !0) || (a ? ic(e, p, !0) : s)),
            gb(g, p, !0));
          if (m)
            return (
              (m = function () {}),
              (m.prototype = (L(g) ? g[g.length - 1] : g).prototype),
              (n = new m()),
              l && f(h, l, n, p || g.name),
              E(
                function () {
      ...
      function (a, b, c, d, p, l) {
        ...
        function A(c, g, k) {
          function l(a, b, c, e) {
            ...
            O && (200 <= a && 300 > a ? O.put(W, [a, b, Fc(c), e]) : O.remove(W));
          ...
          (!c.cache && !e.cache) ||
            ...
            (O = S(c.cache) ? c.cache : S(e.cache) ? e.cache : x);
          if (O)
            if (((H = O.get(W)), B(H))) {
          ...
          F(H) &&
            ((H = Ic(c.url)
              ...
              : s) && (k[c.xsrfHeaderName || e.xsrfHeaderName] = H),
            a(c.method, W, g, l, k, c.timeout, c.withCredentials, c.responseType));
          return M;
        }
        function u(a, b) {
          if (!b) return a;
  ...
  function bf(b) {
    if (
      8 >= X &&
      (!b.match(/^(get|post|head|put|delete|options)$/i) || !t.XMLHttpRequest)
    )
  ...
  function cf(b, a, c, d, e) {
    ...
    return function (e, h, m, k, n, p, l, q) {
      ...
      if ('jsonp' == P(e)) {
        ...
        var T = f(
          h.replace('JSON_CALLBACK', 'angular.callbacks.' + z),
          z,
          function (a, b) {
            u(k, a, d[z].data, '', b);
            d[z] = w;
    ...
    this.$get = [
      ...
      function (c, d, e) {
        ...
        function g(f, g, q, A) {
          ...
          A = !!A;
          for (
            var z, T, v = 0, r = [], Q = [], s = f.length, J = [], N = [];
            v < s;

          )
            if (-1 != (z = f.indexOf(b, v)) && -1 != (T = f.indexOf(a, z + h)))
              v !== z && J.push(u(f.substring(v, z))),
                (v = f.substring(z + h, T)),
                r.push(v),
                Q.push(c(v, x)),
                (v = T + m),
      ...
      function (b, a, c, d) {
        function e(e, h, m, k) {
          ...
          u.$$intervalId = n(function () {
            ...
            0 < m &&
              l >= m &&
              (A.resolve(l), p(u.$$intervalId), delete f[u.$$intervalId]);
            q || b.$apply();
          }, h);
          f[u.$$intervalId] = A;
          return u;
  ...
  function Sb(b, a) {
    ...
    this.$$parse = function (d) {
      var e = wa(b, d) || wa(c, d),
        e = '#' == e.charAt(0) ? wa(a, e) : this.$$html5 ? e : '';
        ...
        f.on('click', function (a) {
          if (!a.ctrlKey && !a.metaKey && 2 != a.which) {
            ...
            n.test(e) ||
              ...
              (a.preventDefault(),
              h.absUrl() != d.url() &&
                (c.$apply(), (t.angular['ff-684208-preventDefault'] = !0)));
          }
        });
  ...
  function Pc(b, a, c) {
    ...
    if (a.csp)
      d =
        6 > f
          ? Oc(e[0], e[1], e[2], e[3], e[4], c)
          : function (a, b) {
              var d = 0,
                g;
              do
                (g = Oc(e[d++], e[d++], e[d++], e[d++], e[d++], c)(a, b)),
                  (b = s),
                  (a = g);
              while (d < f);
              return g;
              ...
              return (
                ...
                p ||
                  (':' === d.charAt(0) &&
                    ...
                    ((l = !0), (d = d.substring(2))),
                  (p = new Tb(a)),
                  (p = new Za(p, c, a).parse(d)),
                  p.constant
                    ? (p.$$watchDelegate = h)
                    : l && ((p = e(p)), (p.$$watchDelegate = p.literal ? g : f)),
                  (b[q] = p)),
                m(p, n)
              );
            case 'function':
  ...
  function Be() {
    ...
    this.$get = [
      ...
      function (e, f, g, h) {
        ...
        function p() {}
        function l() {
          for (var a = A.$$applyAsyncQueue; a.length; )
            try {
              a.shift()();
            } catch (b) {
              f(b);
                    ...
                    for (b in d)
                      d.hasOwnProperty(b) &&
                        ...
                        b in e
                          ...
                          : (q++, (e[b] = f), k++));
                    if (q > a)
                      for (b in (k++, e)) d.hasOwnProperty(b) || (q--, delete e[b]);
                  }
                else e !== d && ((e = d), k++);
                return k;
              }),
            ...
            return this.$watch(m, function () {
              ...
              if (h)
                if (S(d))
                  ...
                  } else for (a in ((f = {}), d)) Ab.call(d, a) && (f[a] = d[a]);
                else f = d;
            });
          },
          $digest: function () {
            ...
            do {
              ...
              a: do {
                ...
                if (!(n = N.$$childHead || (N !== this && N.$$nextSibling)))
                  for (; N !== this && !(n = N.$$nextSibling); ) N = N.$parent;
              } while ((N = n));
              if ((B || q.length) && !J--)
                throw ((A.$$phase = null), a('infdig', b, sa(M)));
            } while (B || q.length);
            for (A.$$phase = null; r.length; )
              try {
                r.shift()();
              } catch (G) {
                f(G);
    ...
    this.$get = function () {
      return function (c, d) {
        var e = d ? a : b,
          f;
        if (!X || 8 <= X)
          if (((f = Aa(c).href), '' !== f && !f.match(e))) return 'unsafe:' + f;
        return c;
      };
    };
  }
  ...
  function Ge() {
    this.$get = [
      ...
      function (b, a) {
        var c = {},
          d = U((/android (\d+)/.exec(P((b.navigator || {}).userAgent)) || [])[1]),
        ...
        if (k) {
          ...
          !d ||
            (n && p) ||
            ((n = C(f.body.style.webkitTransition)),
            (p = C(f.body.style.webkitAnimation)));
        }
        return {
          ...
          findBindings: function (a, b, c) {
            ...
            r(a, function (a) {
              ...
              d &&
                r(d, function (d) {
                  c
                    ? new RegExp('(^|\\s)' + b + '(\\s|\\||$)').test(d) && g.push(a)
  ...
  function Uc(b) {
    ...
    return function (b, d) {
      ...
      return null == b
        ? b
        : Yc(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, 2).replace(/\u00A4/g, d);
    };
  }
  function Wc(b) {
    var a = b.NUMBER_FORMATS;
    return function (b, d) {
      return null == b ? b : Yc(b, a.PATTERNS[0], a.GROUP_SEP, a.DECIMAL_SEP, d);
    };
  }
  function Yc(b, a, c, d, e) {
    ...
    if (k) 0 < e && -1 < b && 1 > b && (h = b.toFixed(e));
      ...
      var n = 0,
        ...
        l = a.gSize;
      if (g.length >= p + l)
        for (n = g.length - p, k = 0; k < n; k++)
          0 === (n - k) % l && 0 !== k && (h += c), (h += g.charAt(k));
      for (k = n; k < g.length; k++)
  ...
  function ad(b) {
    return function (a) {
      ...
      a =
        +new Date(a.getFullYear(), a.getMonth(), a.getDate() + (4 - a.getDay())) -
        +c;
  ...
  function $a(b, a, c, d, e, f) {
    ...
    var n = function (b) {
      if (!k) {
        var e = a.val(),
          f = b && b.type;
        X && 'input' === (b || h).type && a[0].placeholder !== g
          ? (g = a[0].placeholder)
          : ('password' === m || (c.ngTrim && 'false' === c.ngTrim) || (e = ba(e)),
    ...
    return function (c) {
      ...
      if (C(c)) {
        ...
        if ((c = b.exec(c)))
          return (
            c.shift(),
            (d = { yyyy: 1970, MM: 1, dd: 1, HH: 0, mm: 0, ss: 0 }),
            r(c, function (b, c) {
              c < a.length && (d[a[c]] = +b);
            }),
    ...
    return function (e, f, g, h, m, k, n) {
      ...
      h.$parsers.push(function (b) {
        return h.$isEmpty(b)
          ...
          : a.test(b)
          ? ((b = c(b)),
            'UTC' === l && b.setMinutes(b.getMinutes() - b.getTimezoneOffset()),
            b)
          : s;
      });
  ...
  function cd(b) {
    ...
    d.$setValidity = function (b, e, f) {
      e === s
        ...
        : (d.$pending && h(d.$pending, b, f), fd(d.$pending) && (d.$pending = s));
      'boolean' !== typeof e
      ...
      d.$pending
        ? (a(gd, !0), (d.$valid = d.$invalid = s), c('', null))
        : (a(gd, !1),
          (d.$valid = fd(d.$error)),
          (d.$invalid = !d.$valid),
          c('', d.$valid));
  ...
  isNaN(X) &&
    (X = U((/trident\/.*; rv:(\d+)/.exec(P(navigator.userAgent)) || [])[1]));
  w.$inject = [];
  Pa.$inject = [];
  var L = Array.isArray,
    ba = function (b) {
  ...
  var Oe = /([\:\-\_]+(.))/g,
    Pe = /^moz([A-Z])/,
    tf = { mouseleave: 'mouseout', mouseenter: 'mouseover' },
    Hb = K('jqLite'),
    Se = /^<(\w+)\s*\/?>(?:<\/\1>|)$/,
    Gb = /<|&#?\w+;/,
    Qe = /<([\w:]+)/,
  ...
  r(
    {
      ...
      scope: function (b) {
        return (
          G.data(b, '$scope') || pb(b.parentNode || b, ['$isolateScope', '$scope'])
        );
      },
  ...
  r(
    {
      ...
      on: function a(c, d, e, f) {
        ...
        if (rc(c)) {
          ...
          h || (h = g.handle = Ve(c, f));
          for (
            var g = 0 <= d.indexOf(' ') ? d.split(' ') : [d], m = g.length;
            m--;
    ...
    function (a, c) {
      V.prototype[c] = function (c, e, f) {
        for (var g, h = 0, m = this.length; h < m; h++)
          F(g)
            ? ((g = a(this[h], c, e, f)), B(g) && (g = G(g)))
            : tc(g, a(this[h], c, e, f));
        return B(g) ? g : this;
      };
    ...
    search: function (a, c) {
      switch (arguments.length) {
        case 0:
          return this.$$search;
        case 1:
          if (C(a) || ea(a)) (a = a.toString()), (this.$$search = fc(a));
          else if (S(a))
            r(a, function (c, e) {
              null == c && delete a[e];
            }),
  ...
  Tb.prototype = {
    ...
    readIdent: function () {
      for (
        var a = this.text, c = '', d = this.index, e, f, g, h;
  ...
  Za.prototype = {
    ...
    filterChain: function () {
      for (var a = this.expression(), c; (c = this.expect('|')); )
    ...
    unary: function () {
      ...
      return this.expect('+')
        ? this.primary()
        : (a = this.expect('-'))
        ? this.binaryFn(Za.ZERO, a.fn, this.unary())
        : (a = this.expect('!'))
  ...
  var Zc = '.',
    nf = {
      ...
      Z: function (a) {
        ...
        return (a =
          (0 <= a ? '+' : '') +
          (vb(Math[0 < a ? 'floor' : 'ceil'](a / 60), 2) + vb(Math.abs(a % 60), 2)));
      },
      ww: ad(2),
      w: ad(1),
    },
    mf = /((?:[^yMdHhmsaZEw']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z|w+))(.*)/,
    lf = /^\-?\d+$/;
  Vc.$inject = ['$locale'];
  var jf = da(P),
    kf = da(ib);
      ...
      return {
        ...
        link: function (d, e, f) {
          var g = a,
            h = a;
          'href' === a &&
            '[object SVGAnimatedString]' === Ga.call(e.prop('href')) &&
            ((h = 'xlinkHref'), (f.$attr[h] = 'xlink:href'), (g = null));
          f.$observe(c, function (c) {
            c
              ? (f.$set(h, c), X && g && e.prop(g, f[h]))
              : 'href' === a && f.$set(h, null);
          });
        },
      };
  ...
  var id = function (a) {
    ...
    Af = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/,
    Bf = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i,
    Cf = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/,
    jd = /^(\d{4})-(\d{2})-(\d{2})$/,
    kd = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d))?$/,
    Xb = /^(\d{4})-W(\d\d)$/,
    ld = /^(\d{4})-(\d\d)$/,
    md = /^(\d\d):(\d\d)(?::(\d\d))?$/,
    Df = /(\s+|^)default(\s+|$)/,
    ...
    nd = {
      ...
      'datetime-local': ab(
        'datetimelocal',
        kd,
        zb(kd, 'yyyy MM dd HH mm ss'.split(' ')),
        'yyyy-MM-ddTHH:mm:ss'
      ),
      ...
      checkbox: function (a, c, d, e, f, g, h, m) {
        var k = ed(m, a, 'ngTrueValue', d.ngTrueValue, !0),
          n = ed(m, a, 'ngFalseValue', d.ngFalseValue, !1);
        c.on('click', function (a) {
    ...
    Ef = [
      ...
      function (a, c, d, e, f, g, h, m, k) {
        ...
        var n = f(d.ngModel),
          ...
          A = function (c) {
            var d;
            l.$options && l.$options.getterSetter && D((d = n(a)))
              ? d(l.$modelValue)
              : n.assign(a, l.$modelValue);
          };
        this.$$setOptions = function (a) {
          l.$options = a;
          if (!(n.assign || (a && a.getterSetter)))
            throw Yb('nonassign', d.ngModel, ta(e));
        };
        this.$render = w;
        this.$isEmpty = function (a) {
          return F(a) || '' === a || null === a || a !== a;
        };
        var u = e.inheritedData('$formController') || xb,
          x = 0;
        ...
        this.$commitViewValue = function () {
          ...
          h.cancel(p);
          if (
            l.$$lastCommittedViewValue !== a ||
            ('' === a && l.$$hasNativeValidators)
          )
            (l.$$lastCommittedViewValue = a),
              l.$pristine &&
                ((l.$dirty = !0),
        ...
        this.$$parseAndValidate = function () {
          for (
            var a = !0, c = l.$$lastCommittedViewValue, d = c, e = 0;
            e < l.$parsers.length;
            e++
          )
            if (((d = l.$parsers[e](d)), F(d))) {
              a = !1;
              break;
            }
          ea(l.$modelValue) && isNaN(l.$modelValue) && (l.$modelValue = q());
          var f = l.$modelValue,
            h = l.$options && l.$options.allowInvalid;
          h && ((l.$modelValue = d), l.$modelValue !== f && l.$$writeModelToScope());
          l.$$runValidators(a, d, c, function () {
            h ||
              ((l.$modelValue = l.$valid ? d : s),
              l.$modelValue !== f && l.$$writeModelToScope());
          });
        };
        ...
        a.$watch(function () {
          ...
          if (a !== l.$modelValue) {
            ...
            l.$viewValue !== e &&
              ((l.$viewValue = l.$$lastCommittedViewValue = e),
              l.$render(),
              l.$$runValidators(s, a, e, w));
          }
          return a;
        });
      },
      ...
      return {
        ...
        controller: [
          ...
          function (a, c) {
            ...
            this.$options.updateOn !== s
              ? ((this.$options.updateOnDefault = !1),
                (this.$options.updateOn = ba(
                  this.$options.updateOn.replace(Df, function () {
      ...
      function (a, c) {
        ...
        return {
          ...
          link: function (e, f, g) {
            ...
            r(g, function (a, c) {
              s.test(c) &&
                (n[P(c.replace('when', '').replace('Minus', '-'))] = f.attr(
                  g.$attr[c]
                ));
            });
            r(n, function (a, e) {
    ...
    $d = [
      ...
      function (a, c) {
        ...
        return {
          ...
          compile: function (f, g) {
            var h = g.ngRepeat,
              m = Y.createComment(' end ngRepeat: ' + h + ' '),
              k = h.match(
            ...
            return function (a, f, g, k, n) {
              ...
              a.$watchCollection(p, function (g) {
                ...
                if (Na(g)) (y = g), (p = z || B);
                  ...
                  y = [];
                  for (ga in g)
                    g.hasOwnProperty(ga) && '$' != ga.charAt(0) && y.push(ga);
                  y.sort();
                }
                w = y.length;
                ga = Array(w);
                for (k = 0; k < w; k++)
                  if (((N = g === y ? k : y[k]), (E = g[N]), (F = p(N, E, k)), q[F]))
                    (C = q[F]), delete q[F], (x[F] = C), (ga[k] = C);
                  else {
                    if (x[F])
                      throw (
                        (r(ga, function (a) {
                ...
                for (k = 0; k < w; k++)
                  if (((N = g === y ? k : y[k]), (E = g[N]), (C = ga[k]), C.scope)) {
                    J = t;
                    do J = J.nextSibling;
                    while (J && J.$$NG_REMOVED);
          ...
          controller: [
            ...
            function (a, c, d) {
              ...
              m.removeOption = function (a) {
                this.hasOption(a) &&
                  (delete k[a], n.$viewValue == a && this.renderUnknownOption(a));
              };
          ...
          link: function (e, g, h, m) {
            ...
            function p(e, f, h) {
              ...
              function k() {
                ...
                D = !1;
                if (q)
                  if (((g = h.$modelValue), x && L(g)))
                    for (D = new Xa([]), d = {}, t = 0; t < g.length; t++)
                      (d[n] = g[t]), D.put(x(e, d), g[t]);
                  else D = new Xa(g);
                t = D;
                var H, K;
                for (D = 0; (G = A.length), D < G; D++) {
                  ...
                  q
                    ? (d = B(t.remove(x ? x(e, y) : w(e, y))))
                    : (x
                        ? ((d = {}), (d[n] = l), (d = x(e, d) === x(e, y)))
                        : (d = l === w(e, y)),
                      (t = t || d));
                  H = m(e, y);
                  H = B(H) ? H : '';
                ...
                for (A = c.length; y < A; y++) {
                  ...
                  g = a[d];
                  E.length <= y
                    ? ((l = { element: v.clone().attr('label', d), label: g.label }),
                      (s = [l]),
                      E.push(s),
                      f.append(l.element))
                    : ((s = E[y]),
                      (l = s[0]),
                      l.label != d && l.element.attr('label', (l.label = d)));
                  H = null;
                  D = 0;
                  for (G = g.length; D < G; D++)
                    (d = g[D]),
                      (t = s[D + 1])
                        ? ((H = t.element),
                          t.label !== d.label && H.text((t.label = d.label)),
                          t.id !== d.id && H.val((t.id = d.id)),
                          H[0].selected !== d.selected &&
                            (H.prop('selected', (t.selected = d.selected)),
                            X && H.prop('selected', t.selected)))
                        : ('' === d.id && u
                            ? (K = u)
                            : (K = C.clone())
                                .val(d.id)
                          ...
                          H ? H.after(K) : l.element.append(K),
                          (H = K));
              ...
              f.on('change', function () {
                e.$apply(function () {
                  var a,
                    ...
                    v;
                  if (q)
                    for (l = [], r = 0, u = E.length; r < u; r++)
                      for (a = E[r], m = 1, t = a.length; m < t; m++) {
            ...
            if (m[1]) {
              ...
              var q = h.multiple,
                ...
                w,
                z = !1,
                C = G(Y.createElement('option')),
                v = G(Y.createElement('optgroup')),
                y = C.clone();
              h = 0;
              for (var E = g.children(), D = E.length; h < D; h++)
                if ('' === E[h].value) {
                  w = u = E.eq(h);
                  break;
                }
